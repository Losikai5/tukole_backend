...
async def update_provider(provider_id: str, provider_data: ProviderBase, session: AsyncSession = Depends(get_db)):
...
async def delete_provider(provider_id: str, session: AsyncSession = Depends(get_db)):
