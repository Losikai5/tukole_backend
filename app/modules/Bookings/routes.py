...
async def update_booking_status(booking_id: str, status_value: str, session: AsyncSession = Depends(get_db)):

    return await booking_service.update_booking_status(booking_id,status_value,session)
@booking_router.delete("/{booking_id}")
async def delete_booking(booking_id: str, session: AsyncSession = Depends(get_db)):

    await booking_service.delete_booking(booking_id,session)
